...
<head>
	...
	<link rel="stylesheet" href="{{config('app.url')}}raffle/assets/css/odometer.css">
...
<body>
						...
						<div class="jaqport__left">
							<div class="jaqport__title">
								...
								<div class="jaqport__title-button">
									<a href="jaqpot.html" class="default-button"><span>View All <i class="icofont-circled-right"></i></span></a>
								</div>
							</div>
    ...
    <div class="game-section padding-top padding-bottom overflow-hidden d-none" style="background-image:url(assets/images/match/bg.jpg)">
        <div class="container d-none">
            ...
            <ul class="game__filter">
                <li data-filter="*" class="is-checked"><span class="category">All</span></li>
                ...
                <li data-filter=".cat-4"><span class="category">Poker Games</span></li>
            </ul>
			...
			<div class="button-wrapper text-center mt-5">
				<a href="game-list2.html" class="default-button"><span>Browse All Matches <i class="icofont-circled-right"></i></span>
				</a>
			</div>
        </div>
    </div>
					...
					<div class="col-lg-6 col-12">
						<div class="game__content">
							<div class="section-header text-start">
								...
								<p>Assertively communicate an expanded array of mindshare rather than diverse technologies for magnetic applications eamlessly virtual then ussertively communcate an expanded array of mindshare rather think wiverse technologies for magnetic applications eamlessly virtual that conveniently monetize synergistic human capital</p>
								<a href="game-list.html" class="default-button"><span>Browse All Matches <i class="icofont-circled-right"></i></span></a>
							</div>
						</div>
					</div>
				</div>
	...
	<script src="{{config('app.url')}}raffle/assets/js/viewport.jquery.js"></script>
	<script src="{{config('app.url')}}raffle/assets/js/odometer.min.js"></script>
